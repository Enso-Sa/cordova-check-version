...
class CordovaCheckVersion : CDVPlugin {
  @objc(showUpdate:)
  func showUpdate(command: CDVInvokedUrlCommand) {
    CheckUpdate.shared.showUpdate(withConfirmation: (command.arguments[0] as? Bool) ?? false)
